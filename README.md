...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-latex/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-latex/actions/workflows/validate.yml)

Neovim tree-sitter queries for **latex**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-latex",
...
- [ ] Changes are scoped to `latex` — do not include files for other languages
